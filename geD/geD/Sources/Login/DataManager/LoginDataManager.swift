...
class LoginDataManager {
    func kakaoLogin(_ loginInput: LoginInput, viewController: LoginViewController) {
    ...
    func naverLogin(_ loginInput: LoginInput, viewController: LoginViewController) {
        let headers: HTTPHeaders = ["NAVER-ACCESS-TOKEN" : loginInput.accessToken, "DEVICE-TOKEN" : loginInput.deviceToken]
